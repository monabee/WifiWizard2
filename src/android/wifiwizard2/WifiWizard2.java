...
//        wifiManager.reassociate();
   ...
   *
   * This method will wait up to 3 seconds for WiFi connection to specified network ID be in COMPLETED state, otherwise will return error.
   *
